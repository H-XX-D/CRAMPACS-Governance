# CRAMPS Documentation Layer Map

**Document ID:** CRAMPS-DOCMAP-001  
**Version:** 0.1  
**Date:** 2026-05-15 PDT  
...
This document defines the documentation layers for the CRAMPS ecosystem.

The goal is composability:

- A team can run a lowercase `cramps-*` preflight in one to two days.
- The preflight produces seed artifacts.
- Those artifacts can be imported into the uppercase `CRAMPS-*` full system.
...
|---|---|---|
| lowercase `cramps-*` | Lightweight preflight | Triage and escalation recommendation |
| uppercase `CRAMPS-*` | Full assurance system | Defensible evidence package under registered protocol |

Included examples:

- `cramps-med` can compose into `CRAMPS-MED`.
- `cramps-gen` can compose into `CRAMPS-GEN`.
- `cramps-clim` can compose into `CRAMPS-CLIM`.
- `cramps-mat` can compose into `CRAMPS-MAT`.
- `cramps-eng` can compose into `CRAMPS-ENG`.
- `cramps-fin` can compose into `CRAMPS-FIN`.
- `cramps-cyb` can compose into `CRAMPS-CYB`.
- `cramps-ast` can compose into `CRAMPS-AST`.
- `cramps-phy` can compose into `CRAMPS-PHY`.
...
- Define what CRAMPS is and is not.
...
- Define the domain-general CRAMPS method.
...
- `domain_overlays/CRAMPS_MED_MEDICINE_OVERLAY.md`
- `domain_overlays/CRAMPS_GEN_GENOMICS_OVERLAY.md`
- `domain_overlays/CRAMPS_CLIM_CLIMATE_OVERLAY.md`
- `domain_overlays/CRAMPS_MAT_MATERIALS_OVERLAY.md`
- `domain_overlays/CRAMPS_ENG_ENGINEERING_OVERLAY.md`
- `domain_overlays/CRAMPS_FIN_FINANCE_OVERLAY.md`
- `domain_overlays/CRAMPS_CYB_CYBERSECURITY_OVERLAY.md`
- `domain_overlays/CRAMPS_AST_ASTRONOMY_OVERLAY.md`
- `domain_overlays/CRAMPS_PHY_PHYSICS_OVERLAY.md`
...
- `templates/CRAMPS_PROTOCOL_TEMPLATE.md`
...
- Pair CRAMPS controls with field-specific regulatory or assurance systems.
...
```text
cramps-edu  -> education preflight
CRAMPS-EDU  -> education full assurance system
```
