# CRAMPACS Document Style Guide

**Document ID:** CRAMPACS-STYLE-001  
**Version:** 0.1  
**Status:** Draft style standard

## 1. Purpose

This guide makes CRAMPACS documents consistent, teachable, and audit-friendly.
...
CRAMPACS supports controlled anomaly-prioritization and evidence-tier decisions.
...
crampacs-* = 1 to 2 day preflight.
CRAMPACS-* = full assurance package after protocol lock and release review.
```
