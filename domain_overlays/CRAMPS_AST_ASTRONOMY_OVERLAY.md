# CRAMPS-AST Astronomy and Astrophysics Overlay

**Domain:** Astronomy, astrophysics, planetary science, survey astronomy, time-domain astronomy, and multi-messenger observations

## Definition

CRAMPS-AST tests whether weak astronomical residuals, transients, spectral features, timing anomalies, survey near-misses, or null observations recur at pre-specified sky, spectral, temporal, orbital, redshift, or source-class coordinates more often than expected under a registered astrophysical and survey-selection null model.
...
CRAMPS-AST can prioritize astronomical coordinates or source classes for follow-up. It cannot establish discovery, source classification, physical mechanism, or population inference without domain-standard observation and analysis.
