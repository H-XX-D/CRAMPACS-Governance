# CRAMPS-CLIM Climate and Earth Systems Overlay

**Domain:** Climate, weather, hydrology, oceanography, geoscience, and Earth observation

## Definition

CRAMPS-CLIM tests whether weak climate or Earth-system anomalies recur at pre-specified spatial, temporal, spectral, depth, altitude, or regime coordinates more often than expected under a registered Earth-system null model.
...
CRAMPS-CLIM can prioritize recurrent anomaly coordinates or regimes for attribution or monitoring. It cannot establish causal climate attribution without accepted attribution methods and domain review.
