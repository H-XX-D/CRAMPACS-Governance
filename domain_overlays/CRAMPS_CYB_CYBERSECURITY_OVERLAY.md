# CRAMPS-CYB Cybersecurity Overlay
...
CRAMPS-CYB tests whether weak security indicators, alerts, exploit traces, vulnerabilities, or behavioral anomalies recur at pre-specified cyber coordinates more often than expected under a registered infrastructure and threat-activity null model.
...
CRAMPS-CYB can prioritize threat, vulnerability, or detection coordinates. It cannot establish attribution, compromise, exploitability, or legal responsibility without incident response and forensic validation.
