# CRAMPS-GEN Genomics Overlay

**Domain:** Genomics, transcriptomics, proteomics, metabolomics, functional genomics, and multi-omics

## Definition

CRAMPS-GEN tests whether weak omics signals recur at pre-specified genomic, molecular, pathway, cell-state, or variant coordinates more often than expected under a registered biological and technical null model.
...
CRAMPS-GEN can rank candidate loci, genes, pathways, or molecular states for follow-up. It cannot establish clinical pathogenicity, mechanism, biomarker validity, or therapeutic relevance without domain-standard validation.
