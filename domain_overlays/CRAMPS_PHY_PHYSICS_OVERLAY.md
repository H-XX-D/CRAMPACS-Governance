...
CRAMPS-PHY tests whether weak physics anomalies, residuals, excesses, deficits, null searches, exclusions, or near-misses recur at pre-specified physical coordinates more often than expected under a registered physics and literature-process null model.
...
CRAMPS-PHY can prioritize coordinates for targeted searches or prospective tests. It cannot establish discovery, new physics, model confirmation, or exclusion reinterpretation without field-standard experimental confirmation.
