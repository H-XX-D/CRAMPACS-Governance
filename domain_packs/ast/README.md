...
- `crampacs-ast` lightweight preflight
- `CRAMPACS-AST` full assurance study
...
- `crampacs-ast_PREFLIGHT_SCOPE.md`
- `crampacs-ast_PREFLIGHT_SOURCES.csv`
- `crampacs-ast_PREFLIGHT_ROWS.csv`
- `crampacs-ast_PREFLIGHT_GOTCHAS_PRINTABLE.md`
- `crampacs-ast_PREFLIGHT_DECISION.md`
- `CRAMPACS-AST_FULL_PROTOCOL_ADDENDUM.md`
- `CRAMPACS-AST_RELEASE_GATE_PRINTABLE.md`
- `CRAMPACS-AST_DOMAIN_GOVERNANCE_PRINTABLE.md`
