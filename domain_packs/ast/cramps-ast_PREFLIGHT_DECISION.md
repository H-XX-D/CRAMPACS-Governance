...
If escalated, list which artifacts should seed `CRAMPS-AST` and which should be quarantined or reworked.

## Claim Boundary

This is `cramps-ast`. No confirmatory claim is made.
