...
If escalated, list which artifacts should seed `CRAMPS-CYB` and which should be quarantined or reworked.

## Claim Boundary

This is `cramps-cyb`. No confirmatory claim is made.
