# cramps-eng / CRAMPS-ENG Domain Governance Printable

**Domain:** Engineering reliability

## Assurance Split

- `cramps-eng`: one to two day preflight.
- `CRAMPS-ENG`: full assurance system after protocol lock.
