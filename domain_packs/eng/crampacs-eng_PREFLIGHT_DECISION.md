# crampacs-eng Preflight Decision
...
If escalated, list which artifacts should seed `CRAMPACS-ENG` and which should be quarantined or reworked.

## Claim Boundary

This is `crampacs-eng`. No confirmatory claim is made.
