# crampacs-gen Preflight Decision
...
If escalated, list which artifacts should seed `CRAMPACS-GEN` and which should be quarantined or reworked.

## Claim Boundary

This is `crampacs-gen`. No confirmatory claim is made.
