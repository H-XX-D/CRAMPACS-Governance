...
- `crampacs-med` lightweight preflight
- `CRAMPACS-MED` full assurance study
...
- `crampacs-med_PREFLIGHT_SCOPE.md`
- `crampacs-med_PREFLIGHT_SOURCES.csv`
- `crampacs-med_PREFLIGHT_ROWS.csv`
- `crampacs-med_PREFLIGHT_GOTCHAS_PRINTABLE.md`
