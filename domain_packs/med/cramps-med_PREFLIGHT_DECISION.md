...
If escalated, list which artifacts should seed `CRAMPS-MED` and which should be quarantined or reworked.

## Claim Boundary

This is `cramps-med`. No confirmatory claim is made.
