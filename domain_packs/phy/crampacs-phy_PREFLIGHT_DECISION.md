# crampacs-phy Preflight Decision
...
If escalated, list which artifacts should seed `CRAMPACS-PHY` and which should be quarantined or reworked.

## Claim Boundary

This is `crampacs-phy`. No confirmatory claim is made.
