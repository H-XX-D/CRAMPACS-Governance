# CRAMPACS Methodology Policy

**Policy ID:** CRAMPACS-MP-001  
**Version:** 0.1  
**Date:** 2026-05-15 PDT  
...
This policy defines the methodological rules for any CRAMPACS study, regardless of domain.

CRAMPACS tests whether weak signals, anomalies, non-events, exclusions, residuals, failures, or near-misses recur at pre-specified coordinates more often than expected under a registered null model.
...
> This exploratory CRAMPACS atlas identified a possible coordinate recurrence. The coordinate requires a new locked protocol before confirmatory scoring.
...
> This confirmatory CRAMPACS study found cross-catalog recurrence at a pre-specified coordinate under the registered null model.
...
> This prospective CRAMPACS study observed recurrence at a pre-specified coordinate in held-out or future evidence.
...
Nulls and non-events are first-class evidence. A CRAMPACS analysis that includes only positive anomalies is not confirmatory.
...
Tier 4 is not granted by CRAMPACS alone. It requires the domain's normal confirmation standard.
...
The overlay is part of the method contract. A generic CRAMPACS SOP is not enough for a regulated or high-stakes domain.
