# crampacs Gotchas and Sanity Checks

**Guide ID:** crampacs-GOTCHA-001  
**Version:** 0.1  
**Date:** 2026-05-15 PDT  
...
This guide lists the failure modes practitioners should check before trusting a CRAMPACS or crampacs package.
...
- 11-14: candidate for full CRAMPACS.
- 15-16: strong preflight package.

## 5. Practitioner Rule

The fastest way to harden a crampacs pass is not more statistics. It is finding the nulls, mapping dependence, locking the coordinate, and checking units.
