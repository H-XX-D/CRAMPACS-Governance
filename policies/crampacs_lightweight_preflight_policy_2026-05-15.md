# crampacs Lightweight Preflight Policy

**Policy ID:** crampacs-LITE-001  
**Version:** 0.1  
**Date:** 2026-05-15 PDT  
...
`crampacs-*` is the lightweight one to two day version of CRAMPACS.

It helps teams decide whether a suspected weak-signal recurrence deserves full `CRAMPACS-*` treatment.
...
> Is this suspected coordinate recurrence specific, sourced, independent enough, and null-aware enough to justify a full CRAMPACS study?
...
Preflight findings can justify a full CRAMPACS study and should be structured so they can seed that study.
...
1. Start a new uppercase `CRAMPACS-*` workspace.
...
> This crampacs preflight found that the suspected recurrence is [specific / under-specified], has [adequate / inadequate] null coverage, shows [low / moderate / high] dependence risk, and has [low / moderate / high] bias risk. Recommendation: [decision]. No confirmatory claim is made.
