...
| Self-test | temporary package path clears; stale-change, manifest, contract-reference, preflight-agent, and leak-quarantine tamper traps block | `python tools/cramps_cli.py self-test` |
