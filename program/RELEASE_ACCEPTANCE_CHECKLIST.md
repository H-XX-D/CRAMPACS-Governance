...
| Self-test | temporary package path clears; stale-change, manifest, contract-reference, preflight-agent, leak-quarantine, and claim-overreach tamper traps block | `python tools/cramps_cli.py self-test` |
