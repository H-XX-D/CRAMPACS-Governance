# CRAMPACS Training Guide

**Document ID:** CRAMPACS-TRN-001  
**Version:** 0.1  
**Status:** Draft training standard  
**Applies to:** `crampacs-*` preflight and `CRAMPACS-*` full assurance training

## 1. Purpose

This guide defines how to teach CRAMPACS so practitioners can use it safely, consistently, and defensibly.
...
| Preflight workshop | analyst, domain reviewer, project lead | 1 day | complete `crampacs-*` mock preflight |
...
1. Define CRAMPACS in one sentence.
2. Distinguish `crampacs-*` from `CRAMPACS-*`.
...
|---|---|---|
| 09:00 | Method overview | CRAMPACS purpose, boundary, lowercase/uppercase split |
