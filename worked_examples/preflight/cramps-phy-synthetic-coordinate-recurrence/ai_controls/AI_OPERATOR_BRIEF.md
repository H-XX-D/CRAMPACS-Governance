...
4. Copy this folder to an isolated path before running mutating CLI commands.
5. Run `python tools/cramps_cli.py release-check package /tmp/cramps-phy-worked-example --level preflight --force` on the isolated copy.
6. Treat synthetic rows as quarantined from any real full-system scoring.
